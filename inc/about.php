			...
			<div class="welcome-panel-column-container">
				...
				<div class="sidebar">
					...
					<div class="welcome-panel-column-content">
						...
						<a target="_blank" href="#"><?php esc_html_e( 'View Demo', 'udesign' ); ?></a>
						<a target="_blank" href="<?php echo esc_url( '#q' ); ?>"><?php esc_html_e( 'FSE FAQs', 'udesign' ); ?></a>
				...
				<div class="welcome-panel-column review">
					...
					<div class="welcome-panel-column-content">
						...
						<a href="#" class="button button-primary button-hero" style="text-decoration: none;" target="_blank"><?php esc_html_e( 'Review', 'udesign' ); ?></a>
					</div>
				</div>
				</div>
			</div>
